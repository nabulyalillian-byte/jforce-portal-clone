...
2. Brand Logo Marquee / Slider:
   ...
   - Infinite horizontal scrolling track with grayscale-to-color hover cards for brands: Xiaomi, Nivea, Samsung, Unilever, Reckitt, Tecno, Infinix.
...
7. "Commission Structure" & Interactive Earnings Calculator:
   - B2C Commission Table with Navy/Teal header (#1f5673, #174863):
     - Kampala, Entebbe, Jinja: Low (1%), Medium (2%), High (3%)
   ...
   - Indirect Commission details (0.5% fixed across all levels, UGX 130,000 monthly team threshold).
   - Payout dates cards (15th–18th of the month and 2nd–5th of following month).
   - General rules cards (UGX 65,000 min order delivered twice monthly, paid only on Delivered Final items).
   - Working Interactive Earnings Calculator:
     - Select City Location (Kampala/Entebbe/Jinja vs Other Cities)
